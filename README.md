...
En segundo lugar creamos la migracion pet, editamos el up, migramos, editamos el modelo pet, editamos el controlador, registramos la ruta, creamos la vista create.blade e index.blade, finalmente creamos el factory y seeders para editarlos para la ocasion.
