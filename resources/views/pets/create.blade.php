...
class="space-y-4"> 
        ...
        <div> 
            ...
            <input 
                ...
                name="name" 
                required 
                class="w-full border border-gray-300 rounded-lg px-3 
py-2 focus:outline-none focus:ring-2 focus:ring-slate-500" 
            > 
        </div> 
...
py-2 focus:outline-none focus:ring-2 focus:ring-slate-500" 
        ...
        <div class="flex gap-3 pt-4"> 
            <button 
                type="submit" 
                class="bg-green-600 hover:bg-green-700 text-white px-4 
